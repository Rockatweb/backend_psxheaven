...
export interface ApiGameDetailGameDetail extends Struct.CollectionTypeSchema {
  collectionName: 'game_details';
  info: {
    description: '';
    displayName: 'GameDetails';
    pluralName: 'game-details';
    singularName: 'game-detail';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiGameGame extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    dateDone: Schema.Attribute.Date;
    ...
    playlist: Schema.Attribute.Component<'components.video', false>;
    publishedAt: Schema.Attribute.DateTime;
    secretPublishing: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    YTEnd: Schema.Attribute.Date;
    YTStart: Schema.Attribute.DateTime;
  };
}
  ...
  attributes: {
    ...
    components: Schema.Attribute.DynamicZone<
      [
        ...
        'components.headline',
        'components.image',
        'components.multiple-playlists',
        'components.multiple-videos',
        'components.playlist',
        'components.richtext',
        'components.tabbox',
        'components.video',
        'components.linked-games',
        'components.horizontal-row',
        'components.video-by-game-genre',
        'components.rating',
      ]
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    IDs: Schema.Attribute.Component<'ids.i-ds', true>;
    lexicon: Schema.Attribute.Boolean;
    ...
    opener: Schema.Attribute.Component<'components.opener', false>;
...
export interface ApiStreamStream extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    streamplan: Schema.Attribute.Component<'streamplan.stream', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::game-detail.game-detail': ApiGameDetailGameDetail;
